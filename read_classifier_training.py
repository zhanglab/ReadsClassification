...
def main():
    ...
    train_idx_files = sorted(os.path.join(input_dir, 'tfrecords', 'idx_files', f'train-tfrec-*.tfrec.idx'))
    val_files = sorted(glob.glob(os.path.join(input_dir, 'tfrecords', f'val*.tfrec')))
    val_idx_files = sorted(os.path.join(input_dir, 'tfrecords', 'idx_files', f'val-tfrec-*.tfrec.idx'))
